...
![](img/data-science-workflow-1.png){fig-align="center" width=5%}

### <span style="color: darkblue;">Hold on! There's more</span>

![](img/data-science-workflow-2.png){fig-align="center" width=5%}
...
- Let's check the <span style="color: purple;">Jupyter book</span> notes on <span style="color: purple;">Multinomial Logistic regression</span>
...
![](img/multinomial-qr-code.png){.absolute top=170 right=30 width=15%}

## <span style="color: darkblue;">7. Future Work</span>

- A whole <span style="color: purple;">frequentist</span> textbook on <span style="color: purple;">maximum likelihood-based approaches</span>, and open to collaborations!
