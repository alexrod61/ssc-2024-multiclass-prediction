...
![](img/data-science-workflow-1.png){fig-align="center" width=95%}

### <span style="color: darkblue;">Hold on! There's more</span>

. . .

![](img/data-science-workflow-2.png){fig-align="center" width=95%}
...
- Let's check the [Jupyter book](https://ubc-mds.github.io/DSCI_562_regr-2/notes/lecture2_glm_model_selection_multinomial.html#multinomial-logistic-regression) notes on <span style="color: purple;">Multinomial Logistic regression</span>
